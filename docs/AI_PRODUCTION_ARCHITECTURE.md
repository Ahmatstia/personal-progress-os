...
Phase 14 adds a local command layer around the existing Phase 8 AI foundation. The production inference model remains the existing deterministic classifier; the TF-IDF/SVM and transformer experiments remain offline research artifacts.
