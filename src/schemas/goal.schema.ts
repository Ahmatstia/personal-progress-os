...
export const createGoalSchema = z.object({
  ...
  description: z.preprocess((val) => (val === "" ? null : val), z.string().trim().max(5000).optional().nullable()),
  areaId: z.preprocess((val) => (val === "" ? null : val), z.string().trim().min(1).optional().nullable()),
